...
const PROGRESSIONS = {
  ...
  pushVertical: {
    ...
    levels: [
      { name: "Pike-Liegestütz erhöht", type: "reps", cue: "Hüfte hoch, Kopf Richtung Boden, leicht erhöht.", min: 6, max: 15 },
      { name: "Pike-Liegestütz", type: "reps", cue: "Umgedrehtes V, Kopf zwischen den Händen.", min: 6, max: 14 },
      { name: "Erhöhter Pike-Liegestütz", type: "reps", cue: "Füße auf Erhöhung, mehr Gewicht auf Schultern.", min: 5, max: 12 },
      { name: "Wand-Handstand halten", type: "hold", cue: "Brust zur Wand, Bauch fest, Schultern hoch.", min: 15, max: 60 },
      { name: "Wand-Handstand-Liegestütz (Negativ)", type: "reps", cue: "Langsam runter, Hochdrücken mit Sprung erlaubt.", min: 3, max: 8 },
...
const EX_PHOTO = {
  ...
  explosivePull:{ fallback: "Pullups", levels: ["Pullups","Pullups","Muscle_Up","Muscle_Up","Muscle_Up"] },
};
